...
export type SuccessfulReceiveEventMap = {
  VKWebAppInit: 'VKWebAppInitResult';
  ...
  VKWebAppAccelerometerStart: 'VKWebAppAccelerometerStartResult';
  VKWebAppAccelerometerStop: 'VKWebAppAccelerometerStopResult';
  VKWebAppGyroscopeStart: 'VKWebAppGyroscopeStartResult';
};
...
export type FailedReceiveEventMap = {
  VKWebAppInit: 'VKWebAppInitFailed';
  ...
  VKWebAppAccelerometerStart: 'VKWebAppAccelerometerStartFailed';
  VKWebAppAccelerometerStop: 'VKWebAppAccelerometerStopFailed';
  VKWebAppGyroscopeStart: 'VKWebAppGyroscopeStartFailed';
};
