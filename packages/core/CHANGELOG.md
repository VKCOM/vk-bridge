...
- Исправлен импорт `@vkontakte/vk-bridge/package.json`
- Удален postinstall

## v3.0.1

- Добавлена изоляция области видимости для IIFE бандла.
- Исправлена критическая ошибка Identifier 'e' has already been declared при подключении через CDN.
